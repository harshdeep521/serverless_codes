...
var init_error = __esm({
  "node_modules/aws-jwt-verify/dist/esm/error.js"() {
    JwtBaseError = class extends Error {
    };
    FailedAssertionError = class extends JwtBaseError {
    ...
    JwtParseError = class extends JwtBaseError {
      constructor(msg, error) {
        const message = error != null ? `${msg}: ${error}` : msg;
        super(message);
      }
    };
    ParameterValidationError = class extends JwtBaseError {
    };
    JwtInvalidSignatureError = class extends JwtBaseError {
    };
    JwtInvalidSignatureAlgorithmError = class extends FailedAssertionError {
    };
    JwtInvalidClaimError = class extends FailedAssertionError {
    ...
    JwtInvalidIssuerError = class extends JwtInvalidClaimError {
    };
    JwtInvalidAudienceError = class extends JwtInvalidClaimError {
    };
    JwtInvalidScopeError = class extends JwtInvalidClaimError {
    };
    JwtExpiredError = class extends JwtInvalidClaimError {
    };
    JwtNotBeforeError = class extends JwtInvalidClaimError {
    };
    CognitoJwtInvalidGroupError = class extends JwtInvalidClaimError {
    };
    CognitoJwtInvalidTokenUseError = class extends JwtInvalidClaimError {
    };
    CognitoJwtInvalidClientIdError = class extends JwtInvalidClaimError {
    };
    JwksValidationError = class extends JwtBaseError {
    };
    JwkValidationError = class extends JwtBaseError {
    };
    JwtWithoutValidKidError = class extends JwtBaseError {
    };
    KidNotFoundInJwksError = class extends JwtBaseError {
    };
    WaitPeriodNotYetEndedJwkError = class extends JwtBaseError {
    };
    JwksNotAvailableInCacheError = class extends JwtBaseError {
    };
    JwkInvalidUseError = class extends FailedAssertionError {
    };
    JwkInvalidKtyError = class extends FailedAssertionError {
    };
    FetchError = class extends JwtBaseError {
      constructor(uri, msg) {
        super(`Failed to fetch ${uri}: ${msg}`);
      }
    };
    NonRetryableFetchError = class extends FetchError {
    };
  }
});
...
var fetch2, SimpleFetcher;
var init_https = __esm({
  "node_modules/aws-jwt-verify/dist/esm/https.js"() {
    init_error();
    init_node_web_compat_node();
    fetch2 = nodeWebCompat.fetch.bind(void 0);
    SimpleFetcher = class {
      constructor(props) {
...
var init_safe_json_parse = __esm({
  "node_modules/aws-jwt-verify/dist/esm/safe-json-parse.js"() {
  }
});
...
var optionalJwkFieldNames, mandatoryJwkFieldNames, parseJwks, SimplePenaltyBox, SimpleJwksCache;
var init_jwk = __esm({
  "node_modules/aws-jwt-verify/dist/esm/jwk.js"() {
    init_https();
    init_safe_json_parse();
    init_error();
    init_node_web_compat_node();
    init_assert();
...
var supportedSignatureAlgorithms, JwtVerifierBase, KeyObjectCache;
...
var init_cognito_verifier = __esm({
  "node_modules/aws-jwt-verify/dist/esm/cognito-verifier.js"() {
    ...
    init_jwt_verifier();
    init_assert();
    CognitoJwtVerifier = class _CognitoJwtVerifier extends JwtVerifierBase {
...
// node_modules/aws-jwt-verify/dist/esm/cache.js
...
// src/layers/verify.ts
var verify_exports = {};
__export(verify_exports, {
  jwtVerify: () => jwtVerify
});
var verify2, jwtVerify;
var init_verify = __esm({
  "src/layers/verify.ts"() {
    "use strict";
    init_esm();
    verify2 = CognitoJwtVerifier.create({
    ...
    jwtVerify = (token) => {
      try {
        const payload = verify2.verify(token);
        console.log(payload);
        return payload;
      } catch (e) {
        console.log(e);
...
// src/Product/listProduct.ts
import { QueryCommand } from "@aws-sdk/lib-dynamodb";

// src/config/verify.ts
var verifyClient = process.env.AWS_EXECUTION_ENV ? (init_verify(), __toCommonJS(verify_exports)).jwtVerify : __require("/opt/nodejs/verify").jwtVerify;
...
var handler = async (event) => {
  try {
    ...
    do {
      const result = await dbClient2.send(new QueryCommand({
        TableName: "Inventory",
        IndexName: "GS1",
